...
namespace GYM_BE.All.Gym.GymPackage
{
    ...
    public class GymPackageController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> QueryList(PaginationDTO<GymPackageDTO> pagination)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(GymPackageDTO model)
        {
            var response = await _GymPackageRepository.Create(model, "root");
            return Ok(response);
        }
        [HttpPost]
        public async Task<IActionResult> CreateRange(List<GymPackageDTO> models)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Update(GymPackageDTO model)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> UpdateRange(List<GymPackageDTO> models)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Delete(GymPackageDTO model)
        {
            if (model.Id != null)
            {
